...
CREATE TABLE Payment_Options(
    ...
    PRIMARY KEY (user_uuid, Payment_ID ),
...
CREATE TABLE Cart(
    ...
    PRIMARY KEY (user_uuid, item_uuid)
);

ALTER USER inventory_admin WITH PASSWORD '0000';

GRANT SELECT, INSERT, UPDATE, DELETE ON items TO inventory_admin ;

GRANT SELECT ON cart TO data_science_admin ;
GRANT SELECT ON favourites TO data_science_admin ;
GRANT SELECT ON items TO data_science_admin ;
GRANT SELECT ON orders TO data_science_admin ;
GRANT SELECT ON payment_options TO data_science_admin ;
GRANT SELECT ON reviews TO data_science_admin ;


INSERT INTO reviews(user_uuid, item_uuid, review) Values('a12er23', 'davFW313', 'Long text');

INSERT INTO orders(user_uuid, Tracking_Number) Values('a12er23', '9025227971');


INSERT INTO users(user_uuid, email, name, password) Values(
    'u001', 
    'adityang5@gmail.com', 
    'Aditya NG', 
    '12345678'
...
INSERT INTO types(type_uuid, type_name) Values(
    'CPU', 
    'CPU'
);
...
INSERT INTO Payment_Options(user_uuid, Payment_ID, Card_No, valid_from, valid_through) Values(
    'u001', 
    'p001_1',
    '123456789098',
    '2019-01-09',
...
INSERT INTO Items(item_uuid, item_name, item_description, imageURL, productURL, type_uuid, type_name, price) Values(
    '1001',
    'Intel i9-10900k', 
...
INSERT INTO Items(item_uuid, item_name, item_description, imageURL, productURL, type_uuid, price) Values(
    '4001',
    'WD 500GB',
...
INSERT INTO cart(user_uuid, item_uuid, quantity) Values(
    'u001',
    '1001',
    1
);
